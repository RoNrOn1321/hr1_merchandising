  ...
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    <div class="bg-white rounded-lg shadow-md p-5">
      <div class="flex justify-between items-center mb-4">
        ...
        <span class="bg-green-100 text-green-600 px-3 py-1 text-sm rounded-full">Accepted</span>
      </div>
      <p class="text-gray-600 text-sm">Position: Software Developer</p>
      <p class="text-gray-600 text-sm">Offered Salary: ₱60,000</p>
      <p class="text-gray-600 text-sm">Offer Date: Aug 20, 2025</p>
    ...
    <div class="bg-white rounded-lg shadow-md p-5">
      ...
      <p class="text-gray-600 text-sm">Offered Salary: ₱45,000</p>
      <p class="text-gray-600 text-sm">Offer Date: Aug 22, 2025</p>
      <div class="mt-4 flex justify-between">
