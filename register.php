...
<head>
  ...
  <title>HR1-Merchandising | Register</title>
...
<body class="bg-slate-800 flex items-center justify-center min-h-screen p-4">
  <div class="bg-white shadow-2xl rounded-xl w-full max-w-md p-8">
    ...
    <!-- Register Form -->
    <form action="register_auth.php" method="POST" class="space-y-5">
      <div>
    ...
    <p class="text-center text-slate-600 mt-6">
      ...
      <a href="login.php" class="text-slate-700 font-semibold hover:underline">Login</a>
    </p>
  </div>
</body>
</html>
